...
const ar = {
    ...
    translation: {
        ...
        "allow on every visit":
            "عندما يطلب المتصفح الوصول إلى مجلد، اختر «السماح في كل زيارة». أي خيار آخر يدوم لهذه الجلسة فقط وسيسألك المجلد من جديد في المرة القادمة. يظهر هذا الخيار عند تثبيت التطبيق (إضافة إلى الشاشة الرئيسية).",
        "sources persist":
